...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col bg-gray-50">
      {/* Top Navigation */}
      <header className="flex h-16 items-center justify-between border-b bg-white px-6 md:px-10">
        <div className="flex items-center gap-2">
          <span className="text-xl font-bold tracking-tight text-gray-900">HS Toolkit</span>
        </div>
      ...
      <main className="flex flex-1 items-center justify-center p-4 md:p-10">
        <div className="grid w-full max-w-5xl grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base font-medium text-gray-700">Secure Client-Side Storage</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-100 text-green-600">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="h-4 w-4">
                ...
                <span className="text-base font-medium text-gray-700">Direct API Connection</span>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  <span className="font-semibold text-gray-900">Privacy First:</span> Your token is stored locally in your browser. We never see or save your credentials on our servers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center lg:justify-end">
            <Card className="w-full max-w-md border-0 shadow-2xl shadow-gray-200/50 ring-1 ring-gray-200">
